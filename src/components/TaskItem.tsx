...
export function TaskItem({ task, editTask, removeTask, toggleTaskDone }: TasksItemProps) {
  ...
  const textInputRef = useRef<TextInput>(null)//A referência é para você manipular manualmente se o item está sendo editado ou não
  ...
  return (
    <View style={styles.container} >
      ...
      <View style={styles.inconsContainer}>
        {isEditing ? (
          <TouchableOpacity
